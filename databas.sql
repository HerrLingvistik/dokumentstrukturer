...
CREATE TABLE Bicep_Curls(ID INTEGER, Week Integer, Reps INTEGER, Sets INTEGER, Weight DOUBLE);
CREATE TABLE Concentration_Curls(ID INTEGER, Week Integer, Reps INTEGER, Sets INTEGER, Weight DOUBLE);
